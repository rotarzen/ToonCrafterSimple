...
from tooncrafter.util import checkpoint, zero_module
...
class CrossAttention(nn.Module):
    ...
    def forward(self, x, context=None, mask=None):
        ...
        assert k_ip is None and not self.image_cross_attention, "WHAT THE FUCK"
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(self, x, context=None, mask=None, **kwargs):
        return checkpoint(self._forward, x, context, should_ckpt=self.checkpoint, mask=mask)
